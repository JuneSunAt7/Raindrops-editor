...
"border-radius:10px;")
        ...
        self.action_3.setShortcut("Ctrl+E")
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap("examples.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_3.setIcon(icon3)
        self.action_4 = QtWidgets.QAction(MainWindow)
        self.action_4.setObjectName("action_4")
        self.action_4.setShortcut("F5")
        icon4 = QtGui.QIcon()
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.action_4.setText(_translate("MainWindow", "Запустить"))
